...
- 感谢【Lastly1999】，此插件时基于他pr的代码进行的还原和修改。[fix: app-plus、dev/prod、nativeResources插件未被正确移](https://gitee.com/kliveg/unibest/commit/22e0bd5cfb47a4927373fe88be6809216f43d046)
- 感谢【菲鸽】造了这么好用的框架
