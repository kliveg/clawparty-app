...
export const nativeTabbarList: NativeTabBarItem[] = [
  ...
  // },
  // {
  //   iconPath: 'static/tabbar/tutorial.svg',
  //   selectedIconPath: 'static/tabbar/tutorial-active.svg',
  //   pagePath: 'pages/tutorial/index',
  //   text: '%tabbar.tutorial%',
  // },
  // {
  //   iconPath: 'static/tabbar/resources.svg',
  //   selectedIconPath: 'static/tabbar/resource-active.svg',
  //   pagePath: 'pages/resource/index',
  //   text: '%tabbar.resource%',
  // },
  // {
  //   iconPath: 'static/tabbar/cummunity.svg',
  //   selectedIconPath: 'static/tabbar/cummunity-active.svg',
  //   pagePath: 'pages/community/index',
  //   text: '%tabbar.cummunity%',
  // },
  // {
...
export const customTabbarList: CustomTabBarItem[] = [
  ...
  //   iconActive: '/static/tabbar/homeHL.svg',
  // },
  {
    text: '%tabbar.home%',
    pagePath: 'pages/index/index',
  ...
  //   text: '%tabbar.tutorial%',
  //   iconType: 'image',
  //   icon: '/static/tabbar/tutorial.svg',
  //   iconActive: '/static/tabbar/tutorial-active.svg',
  //   // badge: 5,
  // },
  {
    pagePath: 'pages/community/index',
    ...
    iconActive: '/static/tabbar/community-active.svg',
    // badge: 5,
  },
  {
    ...
    text: '%tabbar.chatbot%',
    iconType: 'image',
    icon: '/static/tabbar/chatbot.svg',
    iconActive: '/static/tabbar/chatbot-active.svg',
    // badge: 5,
  },
  {
    pagePath: 'pages/resource/index',
    text: '%tabbar.resource%',
    iconType: 'image',
    icon: '/static/tabbar/resource.svg',
    iconActive: '/static/tabbar/resource-active.svg',
  },
  {
